#
# Be sure to run `pod lib lint InfinitScrollView.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'xiangyu-sun' => 'xiangyu.sun@glovoapp.com' }
  s.source           = { :git => 'https://github.com/xiangyu-sun/InfinitScrollView.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '10.0'

  s.source_files = 'InfinitScrollView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'InfinitScrollView' => ['InfinitScrollView/Assets/*.png']
  # }
